# source: https://github.com/Ackee-Blockchain/woke/blob/main/examples/counter/tests/test_counter_fuzz.py
...
class CounterTest(FuzzTest):
    ...
    def flow_set_count_non_owner(self, new_count: uint):
        with must_revert():
            self._counter.setCount(new_count, from_=random_account(
                predicate=lambda a: a != self._owner))
